...
<!--[if gt IE 8]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
	...
	<head>
		...
		<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
                ...
                <meta name="author" content="Onewoorks Solutions">
		...
		<div class="sidebar">
			...
			<ul>
				...
				<li><a href="<?php echo site_url('invoices/index'); ?>"><img alt="" src="<?php echo base_url(); ?>assets/default/img/icons/invoices24x24.png" title="<?php echo lang('invoices'); ?>" /></a></li>
                                ...
                                <li><a href=""><img alt="" src="<?php echo base_url(); ?>assets/default/img/icons/payments24x24.png" title="<?php echo lang('payments'); ?>" /></a></li>
                        </ul>
