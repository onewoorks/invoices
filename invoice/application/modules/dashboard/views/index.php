    ...
    <div class="row-fluid">
        ...
        <div class="span6">
                ...
                <table class="table no-margin">
                    <tbody>
                        <tr>
                            ...
                            <td><a href="<?php echo site_url('projects/form'); ?>"><i class="icon-briefcase"></i><?php echo "New Project"; ?></a></td>
                            <td><a href="<?php echo site_url('tasks/form'); ?>"><i class="icon-suitcase"></i><?php echo "New Task"; ?></a></td>
                            </tr>
            ...
            <div class="widget overview">
                <div class="widget-title">
                    <h5><i class="icon-bolt"></i><?php echo "New Request!!"; ?></h5>
                </div>
